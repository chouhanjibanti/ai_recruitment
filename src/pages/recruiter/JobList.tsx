...
import { selectJobsList, selectJobsLoading, selectJobsFilters, selectFilteredJobs } from '../../store/slices/jobsSlice';
import { type Job } from '../../types';
import { Briefcase, MapPin, DollarSign, Users, Search, Filter, Plus, Edit, Eye } from 'lucide-react';
    ...
    <div className="p-6">
      ...
      {jobs.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Get started by creating your first job posting.</p>
          <button
            onClick={() => navigate('/recruiter/create-job')}
