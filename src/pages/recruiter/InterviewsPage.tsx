...
import { Calendar, Clock, Video, MapPin, User, CheckCircle, XCircle, AlertCircle, Filter, Search, Eye, Edit, Plus, Trash2, Mail, Phone, ChevronDown, ChevronUp, Users, Briefcase, Star, MessageSquare, FileText, Download } from 'lucide-react';
...
const InterviewsPage: React.FC = () => {
    ...
    const mockInterviews: Interview[] = [
      {
        ...
        candidatePosition: 'Senior Frontend Developer',
        jobId: 'job1',
        ...
        scheduledBy: user?.name || 'Recruiter',
      ...
      },
      {
        ...
        interviewerEmail: 'michael.chen@digitalinnovations.com',
        meetingType: 'video',
        ...
        scheduledBy: user?.name || 'Recruiter',
        scheduledAt: '2024-01-26T14:15:00Z',
        reminderSent: true,
        calendarInviteSent: true,
      },
      {
        ...
        candidatePosition: 'React Developer',
        jobId: 'job3',
        ...
        interviewerEmail: 'emily.rodriguez@startupxyz.com',
        meetingType: 'phone',
        feedback: {
          overall: 4,
          technical: 4,
        ...
        scheduledBy: user?.name || 'Recruiter',
        scheduledAt: '2024-01-20T11:20:00Z',
        reminderSent: true,
        calendarInviteSent: true,
      },
      {
        ...
        interviewerEmail: 'david.kim@enterprisesystems.com',
        meetingType: 'in-person',
        location: 'Boston, MA - Office Building A, Room 302',
        feedback: {
          overall: 5,
          technical: 5,
          communication: 4,
        ...
        scheduledBy: user?.name || 'Recruiter',
        scheduledAt: '2024-01-18T09:45:00Z',
        reminderSent: true,
        calendarInviteSent: true,
      },
      {
        ...
        candidatePosition: 'DevOps Engineer',
        jobId: 'job5',
        ...
        interviewerEmail: 'lisa.thompson@webcraft.com',
        meetingType: 'video',
        meetingLink: 'https://zoom.us/j/987654321',
        notes: 'Interview cancelled by candidate due to scheduling conflict.',
        scheduledBy: user?.name || 'Recruiter',
        scheduledAt: '2024-01-10T16:30:00Z',
        reminderSent: false,
  ...
  const handleReschedule = (interviewId: string) => {
    ...
    navigate(`/recruiter/schedule-interview?candidateId=${interviewId}`);
  };

  const handleCancel = (interviewId: string) => {
    // In real app, this would cancel the interview
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{selectedInterview.candidateEmail}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Phone</p>
                    <p className="font-medium text-gray-900">{selectedInterview.candidatePhone}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Position</p>
                    <p className="font-medium text-gray-900">{selectedInterview.candidatePosition}</p>
                  </div>
                </div>
              </div>
